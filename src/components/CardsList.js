...
const CardsList = (props) => {
  ...
  useEffect(() => {
    axios
      .get(
        `${process.env.REACT_APP_BACKEND_URL}/${props.board.boardId}/cards`
      )
      .then((response) => {
  ...
  const deleteCard = (card) => {
    axios
      .delete(`${process.env.REACT_APP_BACKEND_URL}/${props.board.boardId}/cards/${card.cardId}`)
      .then((response) => {
  ...
  const plusOneLike = (card) => {
    axios
      .put(`${process.env.REACT_APP_BACKEND_URL}/${props.board.boardId}/cards/${card.cardId}/like`)
      .then((response) => {
